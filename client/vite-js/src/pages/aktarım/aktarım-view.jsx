...
const handleChangeFavorite = useCallback((event) => {
 ...
 useEffect(() => {
  const fetchTextData = async () => {
    try {
      const response = await getPageTexts("aktarım")
...
useEffect(() => {
  const fetchImageData = async () => {
    try {
      const imgresponse = await getImages("aktarım");
